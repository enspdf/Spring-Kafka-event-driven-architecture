package me.shackox.productorderanalytics.controller;
...
public class ProductOrdersAnalyticsController {
    ...
    public ResponseEntity<Map<String, String>> analytics() {
        ...
        ReadOnlyKeyValueStore<String, Long> keyValueStore = interactiveQueryService.getQueryableStore(
                ProductOrdersBindings.PRODUCT_ORDERS_CATEGORY_COUNT, QueryableStoreTypes.keyValueStore());
